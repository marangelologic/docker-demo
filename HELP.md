...
* The original package name 'docker.spring.boot.example.docker-spring-boot' is invalid and this project uses 'docker.spring.boot.example.dockerspringboot' instead.
